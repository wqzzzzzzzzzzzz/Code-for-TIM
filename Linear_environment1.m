...
legend('CLMS (\eta=0.01)','CRLS (\lambda=0.99)','MCCC (\eta=0.02,\sigma=5)','RMCL (K_R=2,K_I=1,\lambda=0.99)','RMCL (K_R=4,K_I=1,\lambda=0.99)','TH (RMCL,K_R=2,K_I=1,\lambda=0.99)','TH (RMCL,K_R=4,K_I=1,\lambda=0.99)');
